...
class TestReview_instantiation(unittest.TestCase):
    """Unittests for testing instantiation for the Review class."""
...
class TestReview_save(unittest.TestCase):
    """Unittests for testing save method for the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method for the Review class."""
