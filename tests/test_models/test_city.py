...
class TestCity_instantiation(unittest.TestCase):
    """Unittests for testing instantiation for the City class."""
...
class TestCity_save(unittest.TestCase):
    """Unittests for testing save method for the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method for the City class."""
