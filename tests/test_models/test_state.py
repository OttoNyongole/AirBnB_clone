...
class TestState_instantiation(unittest.TestCase):
    """Unittests for testing instantiation for the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittests for testing save method for the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method for the State class."""
